const btnspan = document.querySelector(".navspan");
...
const home = document.querySelector(".boxhome");
...
// });
//});
const closehome = document.querySelector(".closebox");
...
closehome.addEventListener("click", () => {
  boxhome.classList.remove("show-box");
